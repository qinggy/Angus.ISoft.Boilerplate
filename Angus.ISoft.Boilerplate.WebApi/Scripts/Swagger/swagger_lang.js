                    ...
                    $("#resources_container .resource").each(function (i, item) {
                        ...
                        if (id) {
                            ...
                            if (strSummary) {
                                ...
                                $(item).children(".heading").children(".options").before('<span style="display: inline-block;padding-top: 10px;padding-left: 20px;font-size: 20px;font-weight: bold;">' + strSummary + '</span>');
                            }
                        }
                    });
                }
